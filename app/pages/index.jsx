...
import ztcore from './jquery.ztree.core-3.5'
import zt from './ztree_toc'
...
export default class PreviewPage extends React.Component {
  ...
  onRefreshContent({
    ...
    this.setState({
      ...
      ztcore(window.jQuery);
      zt(window.jQuery);
      jQuery('#tree').ztree_toc({is_auto_number:true});
  ...
  render() {
    ...
    return (
	  ...
	  <link rel="stylesheet" href="/_static/css/zTreeStyle.css" type="text/css" />
	...
	<table border="0" height="1280px" align="left">
		<tr>
			<td width="260px" align="left" valign="top" style={{boarderRight: "#999999 1px dashed"}}>
				<ul id="tree" class="ztree"></ul>
				<ul id="tree-pad" class="ztree-pad" style={{width: "260px"}}></ul>
			</td>
			<td width="1280px" align="left" valign="top">
